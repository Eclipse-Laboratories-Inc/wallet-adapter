...
const ReactUIWalletConnectButtonDynamic = dynamic(
    async () => (await import('@eclipse-laboratories-inc/wallet-adapter-react-ui')).WalletConnectButton,
    { ssr: false }
);
const ReactUIWalletDisconnectButtonDynamic = dynamic(
    async () => (await import('@eclipse-laboratories-inc/wallet-adapter-react-ui')).WalletDisconnectButton,
    { ssr: false }
);
const ReactUIWalletMultiButtonDynamic = dynamic(
    async () => (await import('@eclipse-laboratories-inc/wallet-adapter-react-ui')).WalletMultiButton,
    { ssr: false }
);
const ReactUIWalletModalButtonDynamic = dynamic(
    async () => (await import('@eclipse-laboratories-inc/wallet-adapter-react-ui')).WalletModalButton,
    { ssr: false }
);
